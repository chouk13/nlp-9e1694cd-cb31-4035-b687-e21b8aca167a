...
const PROJECT_NAME = "9e1694cd-cb31-4035-b687-";
...
const IDEA_BRIEF = "Tu es un expert en création de mini-SaaS viraux, ultra rentables, optimisés pour la pub et la scalabilité.\n\nTâche:\n- À partir de la tendance suivante, conçois un mini-SaaS complet.\n\nTendance:\n\"Nom du mini-SaaS : DancePix\nPromesse principale : Transformez n'importe quelle photo en une vidéo où vous dansez sur la tendance virale du moment, prêt à publier sur TikTok.\nPain point principal : Difficulté et temps requis pour créer rapidement une vidéo virale à partir d'une simple photo sans compétences techniques.\nFonctionnalités clés :\n- Upload d'une photo et génération instantanée d'une vidéo dansa";
